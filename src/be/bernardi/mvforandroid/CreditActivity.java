		...
		protected View newView(int position, ViewGroup parent) {
			switch(position) {
				...
				case VALID_UNTIL: {
					...
					// long remainingTime = helper.credit.getValidUntil() -
					...
					Log.v("MVFA", "ratio:" + ratio);
					Log.v("MVFA", "valid until: " + helper.credit.getValidUntil() + " remainingTime:" + remainingTime + " oneMonthInMillis:" + oneMonthInMillis);
					if(ratio < 0)
						validText.setTextColor(0xffa51d1d);
					else if(ratio < RATIO_THRESHOLD)
						validText.setTextColor(0xffff4500);
