...
import be.bernardi.mvforandroid.data.MVDataHelper;
...
public class CreditActivity extends Activity
	...
	public static final String ACTION_REFRESH = "be.bernardi.mvforandroid";
	...
	private BroadcastReceiver msisdnExceptionReceiver = new BroadcastReceiver()
		{
			@Override
			public void onReceive(Context context, Intent intent)
				{
				Exception e = (Exception) intent.getSerializableExtra(MVDataService.EXCEPTION);
				Toast.makeText(context, getString(R.string.exception_msisdn_message, e == null ? "null" : e.getClass().getName()), Toast.LENGTH_LONG).show();
				Log.e(MVDataService.class.getSimpleName(), "No msisdn set", e);
				if(e != null)
					e.printStackTrace();
				CreditActivity.this.getParent().setProgressBarIndeterminateVisibility(false);
				}
	...
	protected void onResume()
		...
		registerReceiver(msisdnExceptionReceiver, new IntentFilter(MVDataService.MSISDN_EXCEPTION));
