...
public class MainActivity extends TabActivity {
	private static final String	FIRST_TIME	= "be.bernardi.mvforandroid.FirstTime";
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch(item.getItemId()) {
			...
			case R.id.update_msisdns:
				Intent update = new Intent(this, MVDataService.class);
	...
	private void showDonateDialog() {
		Intent paypal = new Intent(this, PaypalActivity.class);
