...
public class ExampleAppWidgetProvider extends AppWidgetProvider {
	...
	public void onEnabled(Context context) {
		...
		pm.setComponentEnabledSetting(new ComponentName("be.bernardi.mvforandroid.beta", ".widgets.ExampleBroadcastReceiver"),
	...
	public void onDisabled(Context context) {
		...
		Log.d(getClass().getSimpleName()+": onDisabled");
		PackageManager pm = context.getPackageManager();
		pm.setComponentEnabledSetting(new ComponentName("be.bernardi.mvforandroid.beta", ".widgets.ExampleBroadcastReceiver"),
				PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
	}
	...
	static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId, String titlePrefix) {
		Log.d("updateAppWidget appWidgetId=" + appWidgetId + " titlePrefix=" + titlePrefix);
		// Getting the string this way allows the string to be localized. The
		// format
		// string is filled in using java.util.Formatter-style format strings.
		CharSequence text = context.getString(R.string.appwidget_text_format, ExampleAppWidgetConfigure.loadTitlePref(context, appWidgetId),
