...
package be.bernardi.mvforandroid.beta.widgets;
...
public class WidgetProvider1x1 extends AppWidgetProvider {
	...
	public static final String	ON_WIDGET_CLICK	= "be.bernardi.mvforandroid.beta.onWidgetClick";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(intent.getAction().equals(ON_WIDGET_CLICK)) {
			...
			ComponentName thisWidget = new ComponentName(context, WidgetProvider1x1.class);
	...
	private RemoteViews getViews(Context context) {
		...
		views.setOnClickPendingIntent(R.id.widget_layout1x1, pendingIntent);
	...
	public void updateViewContent(Context context, RemoteViews views) {
		...
		views.setTextViewText(R.id.sms_text, helper.credit.getRemainingSms() + "");
		views.setTextViewText(R.id.sms_mv_text, helper.credit.getRemainingSmsSuperOnNet() + "");
		views.setTextViewText(R.id.data_text, (helper.credit.getRemainingData() / (1024 * 1024)) + "");
